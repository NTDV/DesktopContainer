...
namespace Microsoft.WindowsAPICodePack.Shell
{
    ...
    public class StockIcons
    {
        ...
        public StockIcons()
        {
            ...
            foreach (StockIconIdentifier id in allIdentifiers) stockIconCache.Add(id, null);
        }
        ...
        private StockIcon GetStockIcon(StockIconIdentifier stockIconIdentifier)
        {
            ...
            if (stockIconCache[stockIconIdentifier] != null) return stockIconCache[stockIconIdentifier];
