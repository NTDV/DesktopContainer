...
namespace Microsoft.WindowsAPICodePack.Shell
{
    ...
    public static class KnownFolderHelper
    {
        ...
        public static IKnownFolder FromKnownFolderId(Guid knownFolderId)
        {
            ...
            if (kf == null) throw new ArgumentException("KnownFolderInvalidGuid", nameof(knownFolderId));
            return kf;
        }
        ...
        /// <param name="knownFolderId">A GUID for the requested known folder.</param>
        /// <returns>
        ///     A known folder representing the specified name. Returns null if Known Folder is not found or could not be
        ///     created.
        /// </returns>
        ...
        ///     Thrown if the given canonical name is invalid or if the KnownFolder could
        ///     not be created.
        /// </exception>
        public static IKnownFolder FromCanonicalName(string canonicalName)
        {
            ...
            if (kf == null) throw new ArgumentException("ShellInvalidCanonicalName", nameof(canonicalName));
            return kf;
        }
        ...
        {
            if (parsingName == null) throw new ArgumentNullException(nameof(parsingName));
            ...
            try
            {
                ...
                if (pidl == IntPtr.Zero) throw new ArgumentException("KnownFolderParsingName", nameof(parsingName));
                ...
                {
                    var kf = GetKnownFolder(knownFolderNative);
                    if (kf == null) throw new ArgumentException("KnownFolderParsingName", nameof(parsingName));
                    return kf;
                }
                ...
                if (pidl2 == IntPtr.Zero) throw new ArgumentException("KnownFolderParsingName", nameof(parsingName));

                var kf2 = GetKnownFolder(FromPIDL(pidl));
                if (kf2 == null) throw new ArgumentException("KnownFolderParsingName", nameof(parsingName));
