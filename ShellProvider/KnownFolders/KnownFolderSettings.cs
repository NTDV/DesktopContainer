    ...
    internal class KnownFolderSettings
    {
        ...
        private void GetFolderProperties(IKnownFolderNative knownFolderNative)
        {
            ...
            try
            {
                ...
                knownFolderProperties.localizedNameResourceId =
                ...
                knownFolderProperties.localizedName =
                    CoreHelpers.GetStringResource(knownFolderProperties.localizedNameResourceId);
        ...
        /// <returns>
        ///     A <see cref="System.String" /> containing the path, or <see cref="System.String.Empty" /> if this known folder does
        ///     not exist.
        /// </returns>
