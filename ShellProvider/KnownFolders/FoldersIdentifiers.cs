    ...
    internal static class FolderIdentifiers
    {
        ...
        internal static string NameForGuid(Guid folderId)
        {
            ...
            if (!folders.TryGetValue(folderId, out folder))
                throw new ArgumentException("FolderIdsUnknownGuid", nameof(folderId));
            return folder;
        }
        ...
        internal static SortedList<string, Guid> GetAllFolders()
        {
            ...
            foreach (var g in keys) slist.Add(folders[g], g);
        ...
        ///     Fonts
        /// </summary>
        internal static Guid Fonts = new Guid(0xFD228CB7, 0xAE11, 0x4AE3, 0x86, 0x4C, 0x16, 0xF3, 0x91, 0x0A, 0xB8,
            0xFE);
        ...
        ///     Recent Items
        /// </summary>
        internal static Guid Recent = new Guid(0xAE50C081, 0xEBD2, 0x438A, 0x86, 0x55, 0x8A, 0x09, 0x2E, 0x34, 0x98,
            0x7A);

        /// <summary>
        ///     SendTo
        /// </summary>
        internal static Guid SendTo = new Guid(0x8983036C, 0x27C0, 0x404B, 0x8F, 0x08, 0x10, 0x2D, 0x10, 0xDC, 0xFD,
            0x74);
        ...
        ///     System32
        /// </summary>
        internal static Guid System = new Guid(0x1AC14E77, 0x02E7, 0x4E5D, 0xB7, 0x44, 0x2E, 0xB1, 0xAE, 0x51, 0x98,
            0xB7);
        ...
        ///     Music
        /// </summary>
        internal static Guid Music = new Guid(0x4BD8D571, 0x6D19, 0x48D3, 0xBE, 0x97, 0x42, 0x22, 0x20, 0x08, 0x0E,
            0x43);

        /// <summary>
        ///     Videos
        /// </summary>
        internal static Guid Videos = new Guid(0x18989B1D, 0x99B5, 0x455B, 0x84, 0x1C, 0xAB, 0x7C, 0x74, 0xE4, 0xDD,
            0xFC);
        ...
        ///     Public
        /// </summary>
        internal static Guid Public = new Guid(0xDFDF76A2, 0xC82A, 0x4D63, 0x90, 0x6A, 0x56, 0x44, 0xAC, 0x45, 0x73,
            0x85);
        ...
        ///     Games
        /// </summary>
        internal static Guid Games = new Guid(0xcac52c1a, 0xb53d, 0x4edc, 0x92, 0xd7, 0x6b, 0x2e, 0x8a, 0xc1, 0x94,
            0x34);
        ...
        ///     Links
        /// </summary>
        internal static Guid Links = new Guid(0xbfb9d5e0, 0xc6a9, 0x404c, 0xb2, 0xb2, 0xae, 0x6d, 0xb6, 0xaf, 0x49,
            0x68);
