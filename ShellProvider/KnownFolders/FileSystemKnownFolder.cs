...
namespace Microsoft.WindowsAPICodePack.Shell
{
    ...
    public class FileSystemKnownFolder : ShellFileSystemFolder, IKnownFolder, IDisposable
    {
        ...
        private KnownFolderSettings KnownFolderSettings
        {
            get
            {
                if (knownFolderNative == null)
                {
                    ...
                    if (base.PIDL != IntPtr.Zero) knownFolderNative = KnownFolderHelper.FromPIDL(base.PIDL);
                ...
                if (knownFolderSettings == null) knownFolderSettings = new KnownFolderSettings(knownFolderNative);
        ...
        {
            if (disposing) knownFolderSettings = null;
