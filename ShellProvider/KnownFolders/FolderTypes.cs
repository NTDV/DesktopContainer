...
namespace Microsoft.WindowsAPICodePack.Shell
{
    ...
    {
        /// <summary>
        ///     No particular content type has been detected or specified. This value is not supported in Windows 7 and later
        ///     systems.
        /// </summary>
        ...
        /// <summary>
        ///     The folder is invalid. There are several things that can cause this judgement: hard disk errors, file system
        ///     errors, and compression errors among them.
        /// </summary>
        ...
        /// <summary>
        ///     A default library view without a more specific template. This value is not supported in Windows 7 and later
        ///     systems.
        /// </summary>
        ...
        /// <summary>
        ///     Windows 7 and later. A folder that contains communication-related files such as e-mails, calendar information, and
        ///     contact information.
        /// </summary>
        ...
        static FolderTypes()
        {
            ...
            types.Add(NotSpecified, "FolderTypeNotSpecified");
            types.Add(Invalid, "FolderTypeInvalid");
            types.Add(Communications, "FolderTypeCommunications");
            types.Add(CompressedFolder, "FolderTypeCompressedFolder");
            types.Add(Contacts, "FolderTypeContacts");
            types.Add(ControlPanelCategory, "FolderTypeCategory");
            types.Add(ControlPanelClassic, "FolderTypeClassic");
            types.Add(Documents, "FolderTypeDocuments");
            types.Add(Games, "FolderTypeGames");
            types.Add(GenericSearchResults, "FolderTypeSearchResults");
            types.Add(GenericLibrary, "FolderTypeGenericLibrary");
            types.Add(Library, "FolderTypeLibrary");
            types.Add(Music, "FolderTypeMusic");
            types.Add(MusicIcons, "FolderTypeMusicIcons");
            types.Add(NetworkExplorer, "FolderTypeNetworkExplorer");
            types.Add(OtherUsers, "FolderTypeOtherUsers");
            types.Add(OpenSearch, "FolderTypeOpenSearch");
            types.Add(Pictures, "FolderTypePictures");
            types.Add(Printers, "FolderTypePrinters");
            types.Add(RecycleBin, "FolderTypeRecycleBin");
            types.Add(RecordedTV, "FolderTypeRecordedTV");
            types.Add(SoftwareExplorer, "FolderTypeSoftwareExplorer");
            types.Add(SavedGames, "FolderTypeSavedGames");
            types.Add(SearchConnector, "FolderTypeSearchConnector");
            types.Add(Searches, "FolderTypeSearches");
            types.Add(UsersLibraries, "FolderTypeUserLibraries");
            types.Add(UserFiles, "FolderTypeUserFiles");
            types.Add(Videos, "FolderTypeVideos");
        }
