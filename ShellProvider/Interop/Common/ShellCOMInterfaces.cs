...
#pragma warning disable 108
    ...
    internal interface IShellItem2 : IShellItem
    {
        ...
        [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
        HResult Update([In] [MarshalAs(UnmanagedType.Interface)]
            IBindCtx pbc);
    ...
    internal interface IShellLibrary
    {
        ...
        [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
        void AddFolder([In] [MarshalAs(UnmanagedType.Interface)]
            IShellItem location);

        [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
        void RemoveFolder([In] [MarshalAs(UnmanagedType.Interface)]
            IShellItem location);
    ...
    internal interface IShellFolder
    {
        ...
        void ParseDisplayName(IntPtr hwnd, [In] [MarshalAs(UnmanagedType.Interface)]
            IBindCtx pbc, [In] [MarshalAs(UnmanagedType.LPWStr)] string pszDisplayName, [In] [Out] ref uint pchEaten,
            [Out] IntPtr ppidl, [In] [Out] ref uint pdwAttributes);

        [PreserveSig]
        [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
        HResult EnumObjects([In] IntPtr hwnd, [In] ShellNativeMethods.ShellFolderEnumerationOptions grfFlags,
            [MarshalAs(UnmanagedType.Interface)] out IEnumIDList ppenumIDList);

        [PreserveSig]
        [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
        HResult BindToObject([In] IntPtr pidl, /*[In, MarshalAs(UnmanagedType.Interface)] IBindCtx*/ IntPtr pbc,
    ...
    {
        [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
        void ParseDisplayName([In] IntPtr hwnd, [In] [MarshalAs(UnmanagedType.Interface)]
            IBindCtx pbc, [In] [MarshalAs(UnmanagedType.LPWStr)] string pszDisplayName, [In] [Out] ref uint pchEaten,
            [Out] IntPtr ppidl, [In] [Out] ref uint pdwAttributes);

        [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
        void EnumObjects([In] IntPtr hwnd, [In] ShellNativeMethods.ShellFolderEnumerationOptions grfFlags,
            [MarshalAs(UnmanagedType.Interface)] out IEnumIDList ppenumIDList);

        [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
        void BindToObject([In] IntPtr pidl, /*[In, MarshalAs(UnmanagedType.Interface)] IBindCtx*/ IntPtr pbc,
            [In] ref Guid riid, [Out] [MarshalAs(UnmanagedType.Interface)]
            out IShellFolder ppv);
        ...
        [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
        void GetDetailsEx([In] ref IntPtr pidl, [In] ref PropertyKey pscid,
    ...
    internal interface IPersistStream
    {
        ...
        [PreserveSig]
        HResult Load([In] [MarshalAs(UnmanagedType.Interface)]
            IStream stm);

        [PreserveSig]
        HResult Save([In] [MarshalAs(UnmanagedType.Interface)]
            IStream stm, bool fRemember);
    ...
    internal interface ICondition : IPersistStream
    {
        ...
        [PreserveSig]
        HResult GetSubConditions([In] ref Guid riid, [Out] [MarshalAs(UnmanagedType.Interface)]
            out object ppv);
        ...
        [PreserveSig]
        HResult GetValueType([Out] [MarshalAs(UnmanagedType.LPWStr)]
            out string ppszValueTypeName);
        ...
        [PreserveSig]
        HResult GetValueNormalization([Out] [MarshalAs(UnmanagedType.LPWStr)]
            out string ppszNormalization);
        ...
        [PreserveSig]
        HResult GetInputTerms([Out] out IRichChunk ppPropertyTerm, [Out] out IRichChunk ppOperationTerm,
            [Out] out IRichChunk ppValueTerm);
 ...
 /*[out, annotation("__out_opt")] ULONG* pFirstPos, [out, annotation("__out_opt")] ULONG* pLength, [out, annotation("__deref_opt_out_opt")] LPWSTR* ppsz, [out, annotation("__out_opt")] PROPVARIANT* pValue*/);
    ...
    internal interface IConditionFactory
    {
        ...
        [PreserveSig]
        HResult MakeAndOr([In] SearchConditionType ct, [In] IEnumUnknown peuSubs, [In] bool fSimplify,
 ...
 /*[In] ICondition pc, [In] STRUCTURED_QUERY_RESOLVE_OPTION sqro, [In] ref SYSTEMTIME pstReferenceTime, [Out] out ICondition ppcResolved*/);
    ...
    internal interface ISearchFolderItemFactory
    {
        ...
        [PreserveSig]
        HResult SetVisibleColumns([In] uint cVisibleColumns, [In] [MarshalAs(UnmanagedType.LPArray)]
            PropertyKey[] rgKey);

        [PreserveSig]
        HResult SetSortColumns([In] uint cSortColumns, [In] [MarshalAs(UnmanagedType.LPArray)]
        ...
        [PreserveSig]
        HResult SetStacks([In] uint cStackKeys, [In] [MarshalAs(UnmanagedType.LPArray)]
            PropertyKey[] rgStackKeys);

        [PreserveSig]
        HResult SetScope([In] [MarshalAs(UnmanagedType.Interface)]
            IShellItemArray ppv);
        ...
        [PreserveSig]
        int GetShellItem(ref Guid riid, [Out] [MarshalAs(UnmanagedType.Interface)]
            out IShellItem ppv);
 ...
 /*[In] ICondition pc, [In] int sqro, [In] ref SYSTEMTIME pstReferenceTime, [Out] out ICondition ppcResolved*/);
        ...
        [PreserveSig]
        HResult GetQuery([Out] [MarshalAs(UnmanagedType.Interface)]
            out ICondition ppQueryNode, [Out] [MarshalAs(UnmanagedType.Interface)]
    ...
    internal interface IQueryParser
    {
        ...
        [PreserveSig]
        HResult SetMultiOption([In] StructuredQueryMultipleOption option,
            [In] [MarshalAs(UnmanagedType.LPWStr)] string pszOptionKey, [In] PropVariant pOptionValue);
        ...
        HResult RestatePropertyValueToString([In] ICondition pCondition, [In] bool fUseEnglish,
            [Out] [MarshalAs(UnmanagedType.LPWStr)]
            out string ppszPropertyName, [Out] [MarshalAs(UnmanagedType.LPWStr)]
            out string ppszQueryString);
    }
    ...
    internal interface IQueryParserManager
    {
        ...
        [PreserveSig]
        HResult CreateLoadedParser([In] [MarshalAs(UnmanagedType.LPWStr)] string pszCatalog,
            [In] ushort langidForKeywords, [In] ref Guid riid, [Out] out IQueryParser ppQueryParser);
