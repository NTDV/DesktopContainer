...
namespace Microsoft.WindowsAPICodePack.Shell
{
    internal static class ShellNativeMethods
    {
        ...
        [DllImport("Shell32", CharSet = CharSet.Unicode, CallingConvention = CallingConvention.Winapi,
            SetLastError = true)]
        ...
        internal enum ShellItemDesignNameOptions
        {
            ...
            ParentRelativeForAddressBar =
                unchecked((int) 0x8007c001), // SIGDN_INFOLDER | SIGDN_FORPARSING | SIGDN_FORADDRESSBAR
