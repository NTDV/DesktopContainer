...
#pragma warning disable 0108
    ...
    internal interface IKnownFolderManager
    {
        ...
        [MethodImpl(MethodImplOptions.InternalCall,
            MethodCodeType = MethodCodeType.Runtime)]
        HResult GetFolder([In] [MarshalAs(UnmanagedType.LPStruct)]
            Guid id,
            [Out] [MarshalAs(UnmanagedType.Interface)]
        ...
        [MethodImpl(MethodImplOptions.InternalCall,
            MethodCodeType = MethodCodeType.Runtime)]
        HResult FindFolderFromIDList(IntPtr pidl, [Out] [MarshalAs(UnmanagedType.Interface)]
            out IKnownFolderNative knownFolder);
    ...
    internal class KnownFolderManagerClass : IKnownFolderManager
    {
        ...
        [MethodImpl(MethodImplOptions.InternalCall,
            MethodCodeType = MethodCodeType.Runtime)]
        public virtual extern HResult FindFolderFromIDList(IntPtr pidl, [Out] [MarshalAs(UnmanagedType.Interface)]
            out IKnownFolderNative knownFolder);
