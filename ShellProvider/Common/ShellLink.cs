...
namespace Microsoft.WindowsAPICodePack.Shell
{
    ...
    public class ShellLink : ShellObject
    {
        ...
        public virtual string Path
        {
            get
            {
                if (_internalPath == null && NativeShellItem != null) _internalPath = base.ParsingName;
        ...
        public string TargetLocation
        {
            ...
            set
            {
                ...
                if (NativeShellItem2 != null) Properties.System.Link.TargetParsingPath.Value = internalTargetLocation;
            }
        }
        ...
        public string Title
        {
            ...
            set
            {
                ...
                if (NativeShellItem2 != null) Properties.System.Title.Value = value;
            }
        }
