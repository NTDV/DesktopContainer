...
namespace Microsoft.WindowsAPICodePack.Shell
{
    ...
    public sealed class ShellLibrary : ShellContainer, IList<ShellFileSystemFolder>
    {
            ...
            : this()
        {
            ...
            {
                throw new ArgumentException("ShellLibraryInvalidLibrary", nameof(sourceKnownFolder));
            }
            ...
            : this()
        {
            if (string.IsNullOrEmpty(libraryName))
                throw new ArgumentException("ShellLibraryEmptyName", nameof(libraryName));
            ...
            : this()
        {
            ...
            if (!Directory.Exists(folderPath)) throw new DirectoryNotFoundException("ShellLibraryFolderNotFound");
        ...
        private static LibraryFolderType GetFolderTypefromGuid(Guid folderTypeGuid)
        {
            ...
            throw new ArgumentOutOfRangeException("folderTypeGuid", "ShellLibraryInvalidFolderType");
        }
        ...
        public string DefaultSaveFolder
        {
            ...
            set
            {
                ...
                if (!Directory.Exists(value))
                    throw new DirectoryNotFoundException("ShellLibraryDefaultSaveFolderNotFound");
        ...
        public static ShellLibrary Load(string libraryName, bool isReadOnly)
        {
            ...
            var hr = ShellNativeMethods.SHCreateItemFromParsingName(shellItemPath, IntPtr.Zero, ref guid,
                out nativeShellItem);
        ...
        private static void ShowManageLibraryUI(ShellLibrary shellLibrary, IntPtr windowHandle, string title,
        ...
        public static void ShowManageLibraryUI(string libraryName, string folderPath, IntPtr windowHandle, string title,
            string instruction, bool allowAllLocations)
        {
        ...
        /// <param name="allowAllLocations">If true, do not show warning dialogs about locations that cannot be indexed</param>
        /// <remarks>If the library is already open in read-write mode, the dialog will not save the changes.</remarks>
        public static void ShowManageLibraryUI(string libraryName, IntPtr windowHandle, string title,
            string instruction, bool allowAllLocations)
        {
            // this method is not safe for MTA consumption and will blow
            // Access Violations if called from an MTA thread so we wrap this
        ...
        /// <param name="allowAllLocations">If true, do not show warning dialogs about locations that cannot be indexed</param>
        /// <remarks>If the library is already open in read-write mode, the dialog will not save the changes.</remarks>
        public static void ShowManageLibraryUI(IKnownFolder sourceKnownFolder, IntPtr windowHandle, string title,
            string instruction, bool allowAllLocations)
        {
            // this method is not safe for MTA consumption and will blow
            // Access Violations if called from an MTA thread so we wrap this
        ...
        {
            var list = ItemsList;
            foreach (var folder in list) nativeShellLibrary.RemoveFolder(folder.NativeShellItem);
        ...
        private List<ShellFileSystemFolder> GetFolders()
        {
            ...
            var hr = nativeShellLibrary.GetFolders(ShellNativeMethods.LibraryFolderFilter.AllItems,
