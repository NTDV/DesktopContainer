...
namespace Microsoft.WindowsAPICodePack.Shell
{
    ...
    public class SearchCondition : IDisposable
    {
        ...
        private readonly PropertyKey emptyPropertyKey = new PropertyKey();

        private PropertyKey propertyKey;

        internal SearchCondition(ICondition nativeSearchCondition)
        {
            if (nativeSearchCondition == null) throw new ArgumentNullException(nameof(nativeSearchCondition));
        ...
        public PropertyKey PropertyKey
        {
            get
            {
                ...
                {
                    var hr = PropertySystemNativeMethods.PSGetPropertyKeyFromName(PropertyCanonicalName,
                        out propertyKey);
                    if (!CoreErrorHelper.Succeeded(hr)) throw new ShellException(hr);
                }
        ...
        public IEnumerable<SearchCondition> GetSubConditions()
        {
            ...
            var hr = NativeSearchCondition.GetSubConditions(ref guid, out subConditionObj);
