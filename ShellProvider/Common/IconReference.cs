...
namespace Microsoft.WindowsAPICodePack.Shell
{
    ...
    public struct IconReference
    {
        ...
        public IconReference(string refPath)
            : this()
        {
            if (string.IsNullOrEmpty(refPath)) throw new ArgumentNullException(nameof(refPath));
            ...
            if (refParams.Length != 2 || string.IsNullOrEmpty(refParams[0]) || string.IsNullOrEmpty(refParams[1]))
                throw new ArgumentException($"InvalidReferencePath: {nameof(refPath)}");
        ...
        public string ReferencePath
        {
            ...
            set
            {
                ...
                if (refParams.Length != 2 || string.IsNullOrEmpty(refParams[0]) || string.IsNullOrEmpty(refParams[1]))
                    throw new ArgumentException("InvalidReferencePath", nameof(value));
