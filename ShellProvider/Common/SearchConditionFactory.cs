...
namespace Microsoft.WindowsAPICodePack.Shell
{
    ...
    public static class SearchConditionFactory
    {
        ...
        ///     Specific condition to be used when comparing the actual value and the expected value of the
        ///     given property
        /// </param>
        ...
        ///     <see cref="P:Microsoft.WindowsAPICodePack.Shell.PropertySystem.ShellPropertyDescription.TypeFlags" /> property for
        ///     IsQueryable flag.
        /// </remarks>
        public static SearchCondition CreateLeafCondition(string propertyName, string value,
        ...
        ///     IsQueryable flag.
        /// </remarks>
        public static SearchCondition CreateLeafCondition(string propertyName, DateTime value,
            SearchConditionOperation operation)
        {
            using (var propVar = new PropVariant(value))
            {
                return CreateLeafCondition(propertyName, propVar, "System.StructuredQuery.CustomProperty.DateTime",
                    operation);
            }
        }
        ...
        ///     IsQueryable flag.
        /// </remarks>
        public static SearchCondition CreateLeafCondition(string propertyName, int value,
            SearchConditionOperation operation)
        {
            using (var propVar = new PropVariant(value))
            {
                return CreateLeafCondition(propertyName, propVar, "System.StructuredQuery.CustomProperty.Integer",
                    operation);
            }
        }
            ...
            SearchConditionOperation operation)
        {
            using (var propVar = new PropVariant(value))
            {
                return CreateLeafCondition(propertyName, propVar, "System.StructuredQuery.CustomProperty.Boolean",
                    operation);
            }
        }
        ...
        ///     IsQueryable flag.
        /// </remarks>
        public static SearchCondition CreateLeafCondition(string propertyName, double value,
            SearchConditionOperation operation)
        {
            using (var propVar = new PropVariant(value))
            {
                return CreateLeafCondition(propertyName, propVar, "System.StructuredQuery.CustomProperty.FloatingPoint",
                    operation);
            }
        }
            ...
            SearchConditionOperation operation)
        {
            ...
            {
                if (nativeConditionFactory != null) Marshal.ReleaseComObject(nativeConditionFactory);
            }
        ...
        ///     IsQueryable flag.
        /// </remarks>
        public static SearchCondition CreateLeafCondition(PropertyKey propertyKey, string value,
            SearchConditionOperation operation)
        {
            ...
            if (string.IsNullOrEmpty(canonicalName))
                throw new ArgumentException("SearchConditionFactoryInvalidProperty", nameof(propertyKey));
        ...
        ///     IsQueryable flag.
        /// </remarks>
        public static SearchCondition CreateLeafCondition(PropertyKey propertyKey, DateTime value,
            SearchConditionOperation operation)
        {
            string canonicalName;
            PropertySystemNativeMethods.PSGetNameFromPropertyKey(ref propertyKey, out canonicalName);
        ...
        ///     IsQueryable flag.
        /// </remarks>
        public static SearchCondition CreateLeafCondition(PropertyKey propertyKey, bool value,
            SearchConditionOperation operation)
        {
            string canonicalName;
            PropertySystemNativeMethods.PSGetNameFromPropertyKey(ref propertyKey, out canonicalName);
        ...
        ///     IsQueryable flag.
        /// </remarks>
        public static SearchCondition CreateLeafCondition(PropertyKey propertyKey, double value,
            SearchConditionOperation operation)
        {
            string canonicalName;
            PropertySystemNativeMethods.PSGetNameFromPropertyKey(ref propertyKey, out canonicalName);
        ...
        ///     IsQueryable flag.
        /// </remarks>
        public static SearchCondition CreateLeafCondition(PropertyKey propertyKey, int value,
            SearchConditionOperation operation)
        {
            string canonicalName;
            PropertySystemNativeMethods.PSGetNameFromPropertyKey(ref propertyKey, out canonicalName);
        ...
        {
            if (conditionToBeNegated == null) throw new ArgumentNullException(nameof(conditionToBeNegated));
            ...
            try
            {
                var hr = nativeConditionFactory.MakeNot(conditionToBeNegated.NativeSearchCondition, simplify,
                    out result);
        ...
        public static SearchCondition ParseStructuredQuery(string query, CultureInfo cultureInfo)
        {
            ...
            {
                if (nativeQueryParserManager != null) Marshal.ReleaseComObject(nativeQueryParserManager);

                if (queryParser != null) Marshal.ReleaseComObject(queryParser);

                if (querySolution != null) Marshal.ReleaseComObject(querySolution);

                if (mainType != null) Marshal.ReleaseComObject(mainType);
            }
        }
    }
}