...
namespace MS.WindowsAPICodePack.Internal
{
    ...
    public sealed class PropVariant : IDisposable
    {
        ...
        // architectures.
        [SuppressMessage("Microsoft.Reliability", "CA2006:UseSafeHandleToEncapsulateNativeResources")] [FieldOffset(12)]
        ...
        {
            if (value == null) throw new ArgumentException("PropVariantNullString", nameof(value));
        ...
        private static Array CrackSingleDimSafeArray(IntPtr psa)
        {
            ...
            if (cDims != 1)
                throw new ArgumentException("PropVariantMultiDimArray", nameof(psa));
