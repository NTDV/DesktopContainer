    ...
    public class ShellPropertyCollection : ReadOnlyCollection<IShellProperty>, IDisposable
    {
        ...
        public bool Contains(string canonicalName)
        {
            if (string.IsNullOrEmpty(canonicalName))
                throw new ArgumentException("PropertyCollectionNullCanonicalName", nameof(canonicalName));
        ...
        public IShellProperty this[string canonicalName]
        {
            get
            {
                ...
                if (prop == null) throw new IndexOutOfRangeException("PropertyCollectionCanonicalInvalidIndex");
                return prop;
            }
        }
        ...
        public IShellProperty this[PropertyKey key]
        {
            get
            {
                ...
                throw new IndexOutOfRangeException("PropertyCollectionInvalidIndex");
            }
        }
