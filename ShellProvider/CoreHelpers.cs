...
namespace MS.WindowsAPICodePack.Internal
{
    ...
    public static class CoreHelpers
    {
        ...
        {
            if (!RunningOnVista) throw new PlatformNotSupportedException("CoreHelpersRunningOnVista");
        }
        ...
        {
            if (!RunningOnWin7) throw new PlatformNotSupportedException("CoreHelpersRunningOn7");
        }
